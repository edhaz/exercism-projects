...
class MatrixTest(unittest.TestCase):
    ...
    def test_large_matrix(self):
        matrix = Matrix("283 1298 12873 1232\n8763 83764 3874 2938\n9182 2938 92837 3874\n83746 3764 3746 3874")
        self.assertEqual(matrix.column(2), [1298, 83764, 2938, 3764])

    def test_ask_for_column_out_of_matrix(self):
        matrix = Matrix("1 2 3\n4 5 6\n7 8 9")
        self.assertRaises(Exception, matrix.column, 4)

    def test_ask_for_row_out_of_matrix(self):
        matrix = Matrix("1 2 3\n4 5 6\n7 8 9")
        self.assertRaises(Exception, matrix.row, 4)
